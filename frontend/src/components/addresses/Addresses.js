...
const classes = useStyles();
    ...
    return (
        <div>
            {/* Title */}
            <Grid style={{marginBottom: '10px'}} container direction="row" alignItems="center">
                <Grid item>
                    <HomeIcon/>
                </Grid>
                <Grid item>
            ...
            <Grid item xs={12}>
                <ThingahaTabbedNav
                tabMenus={[
                    <div><SchoolIcon style={{verticalAlign: 'text-top'}} />{labelStudents}</div>,
                    <div><LocationCityIcon style={{verticalAlign: 'text-top'}} />{labelSchools}</div>,
                    <div><MonetizationOnIcon style={{verticalAlign: 'text-top'}} />{labelDonators}</div>,
                ]}
                tabPanels={[
                    <AddressesList 
