...
export const SUBMIT_NEW_SCHOOL_FORM_SUCCESS = 'SCHOOLS/SUBMIT_NEW_SCHOOL_FORM_SUCCESS'
export const SUBMIT_NEW_SCHOOL_FORM_FAILURE = 'SCHOOLS/SUBMIT_NEW_SCHOOL_FORM_FAILURE'
export const SUBMIT_EDIT_SCHOOL_FORM = 'SCHOOLS/SUBMIT_EDIT_SCHOOL_FORM'
export const SUBMIT_EDIT_SCHOOL_FORM_SUCCESS = 'SCHOOLS/SUBMIT_EDIT_SCHOOL_FORM_SUCCESS'
export const SUBMIT_EDIT_SCHOOL_FORM_FAILURE = 'SCHOOLS/SUBMIT_EDIT_SCHOOL_FORM_FAILURE'
