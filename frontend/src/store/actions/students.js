...
export const SUBMIT_NEW_STUDENT_FORM_SUCCESS = 'STUDENTS/SUBMIT_NEW_STUDENT_FORM_SUCCESS'
export const SUBMIT_NEW_STUDENT_FORM_FAILURE = 'STUDENTS/SUBMIT_NEW_STUDENT_FORM_FAILURE'
export const SUBMIT_EDIT_STUDENT_FORM = 'STUDENTS/SUBMIT_EDIT_STUDENT_FORM'
export const SUBMIT_EDIT_STUDENT_FORM_SUCCESS = 'STUDENTS/SUBMIT_EDIT_STUDENT_FORM_SUCCESS'
export const SUBMIT_EDIT_STUDENT_FORM_FAILURE = 'STUDENTS/SUBMIT_EDIT_STUDENT_FORM_FAILURE'
