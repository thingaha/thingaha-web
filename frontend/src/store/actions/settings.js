...
export const GET_ACCOUNT_USER_INFO_SUCCESS = 'SETTINGS/GET_ACCOUNT_USER_INFO_SUCCESS'
export const GET_ACCOUNT_USER_INFO_FAILURE = 'SETTINGS/GET_ACCOUNT_USER_INFO_FAILURE'
